...
(function () {
  ...
  style.textContent = [
    ...
    '.mnav-link{display:block;font-family:var(--font-body);font-size:1.55rem;font-weight:700;color:var(--text-strong);text-decoration:none;padding:14px 0;border-bottom:1px solid var(--border-hairline);line-height:1.2;transition:color .2s;letter-spacing:-.01em;}',
    '.mnav-link:hover{color:var(--text-accent);}',
    '.mnav-has-sub{border-bottom:1px solid var(--border-hairline);}',
    '.mnav-strigger{background:none;border:none;width:100%;text-align:left;font-family:var(--font-body);font-size:1.55rem;font-weight:700;color:var(--text-strong);padding:14px 0;cursor:pointer;display:flex;align-items:center;justify-content:space-between;gap:12px;line-height:1.2;letter-spacing:-.01em;}',
